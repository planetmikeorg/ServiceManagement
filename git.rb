...
external_url 'https://devops.klik.solutions'
...
registry_external_url 'https://packages.klik.solutions'
...
letsencrypt['contact_emails'] = ['enterpriseops@klik.solutions'] # This should be an array of email addresses to add as contacts
